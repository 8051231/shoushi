...
namespace Hi5_Interaction_Core
{
    public class Hi5_Interaction_Object_Manager : MonoBehaviour
    {
        ...
        static public Hi5_Interaction_Object_Manager mManager = null;
        //public Transform tempMove;
        static Dictionary<int, Hi5_Glove_Interaction_Item> mObjectDic = new Dictionary<int, Hi5_Glove_Interaction_Item>();
        #region unity system
        private void Awake()
        {
